...
function ComfyUICanvasView(props) {
  ...
  var hostEl = React.createElement("div", { ref: rootRef, style: { flex: "1 1 0", minHeight: 0, minWidth: 0, position: "relative" } }, control);
  var pieces = [hostEl];
  // 有待审批项时在画布上叠加授权弹窗（DSH 分屏布局不渲染它，全屏模态）。
  if (approval) pieces.push(React.createElement(ComfyUIApprovalOverlay, { wait: approval }));
